...
set(Acts_COMPONENTS Core;PluginIdentification;PluginJson;PluginTGeo;PluginDD4hep;Fatras)
set(Acts_COMMIT_HASH "a7cd583a222940808426298c2cbd6b980c5022dd")
set(Acts_COMMIT_HASH_SHORT "a7cd583a2")
...
if(ON)
  find_dependency(Boost 1.74.0 CONFIG EXACT)
endif()
if(ON)
  find_dependency(Eigen3 3.3.9 CONFIG EXACT)
endif()
if(PluginAutodiff IN_LIST Acts_COMPONENTS)
  find_dependency(autodiff  CONFIG EXACT)
endif()
if(PluginDD4hep IN_LIST Acts_COMPONENTS)
  find_dependency(DD4hep 1.25 CONFIG EXACT)
endif()
if(PluginJson IN_LIST Acts_COMPONENTS)
  find_dependency(nlohmann_json 3.10.5 CONFIG EXACT)
endif()
if(PluginTGeo IN_LIST Acts_COMPONENTS)
  find_dependency(ROOT 6.26.10 CONFIG EXACT)
endif()

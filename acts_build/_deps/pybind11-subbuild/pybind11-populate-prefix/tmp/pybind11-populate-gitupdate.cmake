...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.10.1"
  WORKING_DIRECTORY "/home/sasa/work/acts-kiwaku/acts_build/_deps/pybind11-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.10.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.10.1")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/sasa/work/acts-kiwaku/acts_build/_deps/pybind11-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sasa/work/acts-kiwaku/acts_build/_deps/pybind11-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
